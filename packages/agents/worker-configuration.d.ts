// Generated by Wrangler by running `wrangler types` (hash: b9b5920c96b8683cc7047f10c9b966bc)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "CLOUDFLARE_SECRET_KEY">> {}
}
